...
// No measurable speed impact. I was hoping to get a speed gain as by using the amigaos
// unbuffered functions (deliberately), the app has one buffered layer and not two. (One
...
GLOBAL struct SymTab *FwdBranchFix[128]; /* Symbol table entries to fix */
